...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\arrar\Desktop\Python practice\gameTu'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\arrar\Desktop\Python practice\gameTu\Scripts\deactivate.nu'
